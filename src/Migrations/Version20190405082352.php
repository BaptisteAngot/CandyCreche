 ...
 */
final class Version20190405082352 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE authorize_user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, relation_id INTEGER DEFAULT NULL, authorize_login VARCHAR(255) NOT NULL, authorize_password VARCHAR(255) NOT NULL, authorize_created_at DATETIME NOT NULL, authorize_updated_at DATETIME DEFAULT NULL)');
        $this->addSql('CREATE INDEX IDX_9D415A043256915B ON authorize_user (relation_id)');
        $this->addSql('CREATE TABLE booking (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, begin_at DATETIME NOT NULL, end_at DATETIME DEFAULT NULL, title VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('CREATE TABLE opinion (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, opinion_id_parents_id INTEGER DEFAULT NULL, opinion_id_structure_id INTEGER DEFAULT NULL, opinion_created_at DATETIME NOT NULL, opinion_updated_at DATETIME DEFAULT NULL, opinion_rate INTEGER NOT NULL, opinion_comment VARCHAR(255) DEFAULT NULL)');
        ...
        $this->addSql('CREATE TABLE parents (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , parents_name VARCHAR(255) NOT NULL, parents_firstname VARCHAR(255) NOT NULL, parents_mail VARCHAR(255) NOT NULL, parents_password VARCHAR(255) NOT NULL, parents_created_at DATETIME NOT NULL, parents_updated_at DATETIME DEFAULT NULL, parents_token VARCHAR(255) NOT NULL, parents_photo VARCHAR(255) DEFAULT NULL)');
